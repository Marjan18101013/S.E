...
def showproduct(request):
    ...
    return render(request, 'PetShop/Addproduct.html', context)
...
def orderproduct(request):
    ...
    return render(request, 'PetShop/OrderProduct.html', context)
def showDetails(request, product_id):
    ...
    return render(request, 'Petshop/details.html', context)
